...
/**
 * description:
 *      一般情况下，Spring通过反射机制利用bean的class属性指定支线类去实例化bean，在某些情况下，
 ...
 *
 *
 * @date: 2020年10月23日 19:53
 * @author: qinrenchuan
 */
@Component
public class MyExtensionAjFactoryBean implements FactoryBean<MyExtensionAjFactoryBean.TestFactoryInnerBean> {

    @Override
    public TestFactoryInnerBean getObject() throws Exception {
        System.out.println("[MyExtensionAjFactoryBean]getObject");
